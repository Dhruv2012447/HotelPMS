              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gradient-to-r from-blue-100 to-blue-200 text-gray-700 sticky top-0">
                  <tr>
                    ...
                    {/* <th className="p-3 text-left text-sm font-semibold uppercase tracking-wide">ID</th> */}
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {gms.map((gm, idx) => (
                    ...
                    >
                      ...
                      {/* <td className="p-3 text-gray-800">{gm._id}</td> */}
                      ...
                      <td className="p-3 flex gap-2">
                        <button
                          onClick={() => router.push(`/gms/${gm._id}/edit`)}
